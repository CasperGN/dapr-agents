...
class MeterProvider:
    ...
    def __init__(self, resource=None, metric_readers=None, **kwargs):
...
class DaprAgentsOTel:
    ...
    def __init__(self, service_name: str = "", otlp_endpoint: str = ""):
        self.service_name = service_name or os.environ.get(
            ENV_SERVICE_NAME, "dapr-agents"
        )
        self.deployment_environment = os.environ.get(
    ...
    def create_and_instrument_meter_provider(
        ...
        # Get export interval - would be used in a real implementation
        _ = int(os.environ.get("OTEL_METRIC_EXPORT_INTERVAL", 60000))
    ...
    def create_and_instrument_logging_provider(
        ...
        # Get batch size - would be used in a real implementation
        _ = int(os.environ.get("OTEL_LOGS_EXPORT_BATCH_SIZE", 512))
